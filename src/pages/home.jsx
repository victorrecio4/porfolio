        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { name: 'PHP', color: 'accent3' },
              { name: 'Git', color: 'accent4' },
              { name: 'XPS/Longo Match', color: 'accent' },
              { name: 'Big Data Deportivo', color: 'accent2' },
              { name: 'Power BI/ Tableau', color: 'accent3' },
              { name: 'Linux consola', color: 'accent4' },
              { name: 'Bitbucket', color: 'accent' },
              { name: 'Docker', color: 'accent2' },
              { name: 'Flask', color: 'accent3' },
              { name: 'Excel/Hojas de calculo', color: 'accent4' },
              { name: 'MySQL', color: 'accent' },
              { name: 'TailwindCSS', color: 'accent2' },
              { name: 'Canvas', color: 'accent3' },
              { name: 'Análisis de Datos', color: 'accent4' },
            ].map((skill, index) => (
              <motion.div
                key={skill.name}
                initial={{ opacity: 0, y: 20 }}
